...
p.2bm<-my_replace(p,c(number_BM=4))
...
bm_2<-run(condition = "4BM", params  = p.2bm)

## ibm
ibm_1<-run(condition = "iBM", state = s.par)
ibm_2<-run(condition = "iBM + 3BM", state = s.par, params = p.2bm)
...
pdf(paste0("C:\\Users\\isabe\\OneDrive\\Documentos\\GitHub\\resourceallocation\\results\\figures",Sys.Date(), "_betaP.pdf"), width = 9.5, height = 6.25)
visualize(rbind(bm_2, ibm_beta_P, ibm_2_beta_P), cum = TRUE)+theme_bw(base_size = 16*96/72)
dev.off()

## visualize the results ----
png(paste0("C:\\Users\\isabe\\OneDrive\\Documentos\\GitHub\\resourceallocation\\results\\figures",Sys.Date(), "_all.png"), width = 12, height = 6.25, units = "in", res = 400)
visualize(rbind(ibm_1, bm_2, ibm_2))+theme_bw(base_size = 16*96/72)
dev.off()

pdf(paste0("C:\\Users\\isabe\\OneDrive\\Documentos\\GitHub\\resourceallocation\\results\\figures",Sys.Date(), "_all.pdf"), width = 9.5, height = 6.25)
visualize(rbind(bm_1, ibm_1, bm_2, ibm_2))+theme_bw(base_size = 16*96/72)
dev.off()

png(paste0("C:\\Users\\isabe\\OneDrive\\Documentos\\GitHub\\resourceallocation\\results\\figures",Sys.Date(), "_weak_all.png"), width = 18.5, height = 12.25, units = "in", res = 400)
visualize(rbind(bm_2, ibm_2,w_bm_K,w_ibm_K,w_bm_R,w_ibm_R, poor_bm))+theme_bw(base_size = 16*96/72)
dev.off()

png(paste0("C:\\Users\\isabe\\OneDrive\\Documentos\\GitHub\\resourceallocation\\results\\figures",Sys.Date(), "_weak_R.png"), width = 9.5, height = 6.25, units = "in", res = 400)
visualize(rbind(bm_2, ibm_2,w_bm_R,w_ibm_R))+theme_bw(base_size = 16*96/72)
dev.off()

png(paste0("C:\\Users\\isabe\\OneDrive\\Documentos\\GitHub\\resourceallocation\\results\\figures",Sys.Date(), "_weak_K.png"), width = 9.5, height = 6.25, units = "in", res = 400)
visualize(rbind(bm_2, ibm_2,w_bm_K,w_ibm_K))+theme_bw(base_size = 16*96/72)
dev.off()

png(paste0("C:\\Users\\isabe\\OneDrive\\Documentos\\GitHub\\resourceallocation\\results\\figures",Sys.Date(), "_weak_bm.png"), width = 9.5, height = 6.25, units = "in", res = 400)
